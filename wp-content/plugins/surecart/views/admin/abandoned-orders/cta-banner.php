		...
		<div class="sc-banner-top-area">
			<div class="sc-banner-text">
				...
				<sc-text style="--font-size: var(--sc-font-size-xxx-large); --line-height: 50px; --font-weight: var(--sc-font-weight-bold); ">
					<br>
<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_html_e() in E:\xampp\htdocs\testsite\wordpress-6.6.1-zh_CN\wordpress\wp-content\plugins\surecart\views\admin\abandoned-orders\cta-banner.php:99
Stack trace:
#0 {main}
  thrown in <b>E:\xampp\htdocs\testsite\wordpress-6.6.1-zh_CN\wordpress\wp-content\plugins\surecart\views\admin\abandoned-orders\cta-banner.php</b> on line <b>99</b><br>
</sc-text>
</div>
</div>
</div>
